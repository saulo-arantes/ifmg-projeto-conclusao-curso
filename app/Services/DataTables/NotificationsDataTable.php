			...
			->editColumn('type', function (Notification $model) {
				switch ($model->type) {
					case Notification::VALIDATOR:
						return '<span class="label label-warning label-xs">Validator</span>';
					case Notification::ERROR:
						return '<span class="label label-danger label-xs">Exception</span>';
					case Notification::DENIED:
						return '<span class="label label-warning label-xs">Denied</span>';
					case Notification::INFO:
						return '<span class="label label-info label-xs">Info</span>';
					default:
						return '<span class="label label-danger label-xs">Erro desconhecido</span>';
				}
				...
				if (empty($model->read_at)) {
					return '<a href="' . route('visualizeAll') . '" style="color: black" class="btn btn-xs"><i class="fa fa-eye"></i></a><br>Visualizar todas';
				}
